...
RSpec.describe CharactersController do
  ...
  describe "GET show" do
    ...
    it "should set correct variables" do
      ...
      expect(assigns(:posts)).to match_array(Post.where(id: Reply.where(character_id: character.id).select(:post_id).distinct.pluck(:post_id)).order('tagged_at desc').limit(25))
    end
